  ...
  <div class="" style="width: 200px">
    ...
    <li class="list-group-item"> <h4>Election Summary</h4> </li>
        ...
        <ul class="list-group">
            ...
            <li class="list-group-item list-group-item-secondary">Total number of 1st Year Students who voted: <?php echo count($year_1); ?></li>
            <li class="list-group-item list-group-item-secondary">Total number of 2nd Year Students who voted: <?php echo count($year_2); ?></li>
            <li class="list-group-item list-group-item-secondary">Total number of 3rd Year Students who voted: <?php echo count($year_3); ?></li>
            <li class="list-group-item list-group-item-secondary">Total number of 4th Year Students who voted: <?php echo count($year_4); ?></li>
        </ul>
